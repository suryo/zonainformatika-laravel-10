...
<div class="wrapper d-flex flex-column flex-row-fluid mt-5 mt-lg-10" id="kt_wrapper">
        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column py-1">
                ...
                <h1 class="d-flex align-items-center my-1">
                    <span class="text-gray-900 fw-bold fs-1">All Article</span>
                    <!--begin::Description-->
                    <small class="text-muted fs-6 fw-semibold ms-1">({{ count($articles) }})</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
        ...
        <div class="post" id="kt_post">
            ...
            <div class="mb-10">
                ...
                <div class="mb-0">
                    ...
                    <!--end::Head-->
                    <!--begin::Summary-->
                    <div class="fs-base fw-normal text-gray-700 mb-4">{{ ($article->short_desc) }} </div>
                    <!--end::Summary-->
                    <!--begin::Foot-->
                    <div class="d-flex flex-stack flex-wrap">
                        ...
                        <div class="d-flex align-items-center py-1">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center">
                                <span class="text-gray-900 fs-7 fw-semibold lh-1 mb-2">{{ $article->author }}</span>
                                {{-- <span class="text-muted fs-8 fw-semibold lh-1">{{ count($article->courseDetails) }} SubCourse</span> --}}
            ...
            <!--end::Questions-->
            <!--begin::Pagination-->
            <div class="d-none d-flex flex-center mb-0">
    ...
    <div class="footer pt-10 pb-5 d-flex flex-column flex-md-row flex-stack" id="kt_footer">
        ...
        <!--end::Copyright-->
        <!--begin::Menu-->
        <ul class="d-none menu menu-gray-600 menu-hover-primary fw-semibold order-1">
            <li class="menu-item">
