        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column py-1">
                ...
                <h1 class="d-flex align-items-center my-1">
                    <span class="text-gray-900 fw-bold fs-1">Articles & News</span>
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Articles & News</li>
                    <!--end::Item-->
                        ...
                        <div class="flex-lg-row-fluid me-xl-15">
                            ...
                            <div class="mb-17">
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="d-flex flex-wrap mb-6">
                                        ...
                                        <!--end::Item-->
                                         ...
                                         <div class="me-9 my-1">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Label-->
                                            <span class="fw-bold text-gray-500">Author : {{ $article->author }} </span>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Item-->
                                    ...
                                    <!--end::Info-->
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold">{{ $article->title }} 
                                    </a><br>
                                    <a href="{{ route('article') }}" class="text-gray-900 text-hover-danger fs-5 fw-bold"><-- Back 
                                    <!--end::Title-->
                                    <!--begin::Container-->
                                ...
                                <div class="fs-5 fw-semibold text-gray-600">
                                    ...
                                    <textarea class="mb-3 d-none" style="min-height:100%; height:auto;"  name="desc" id="quill-editor-area">{{ $article->text }}</textarea>
