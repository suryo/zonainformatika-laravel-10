        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column py-1">
                ...
                <h1 class="d-flex align-items-center my-1">
                    <span class="text-gray-900 fw-bold fs-1">All Project & Code</span>
                    <!--begin::Description-->
                    <small class="text-muted fs-6 fw-semibold ms-1">({{ count($projects) }})</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
            ...
            <div class="mb-10">
                ...
                <div class="mb-0">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <!--begin::Title-->
                        <a href="{{ route('project.detail', ['id' => $project->id]) }}" class="fs-2 fw-bold text-gray-900 text-hover-primary me-1">{{ $project->project }}</a>
                        <!--end::Title-->
                       
                    </div>
                    <!--end::Head-->
                    <!--begin::Summary-->
                    <div class="fs-base fw-normal text-gray-700 mb-4">{{ ($project->short_desc) }} </div>
                    <!--end::Summary-->
                    <!--begin::Foot-->
                    <div class="d-flex flex-stack flex-wrap">
                        ...
                        <div class="d-flex align-items-center py-1">
                            ...
                            <div class="d-flex flex-column align-items-start justify-content-center">
                                <span class="text-gray-900 fs-7 fw-semibold lh-1 mb-2">{{ $project->author }}</span>
                                <span class="text-muted fs-8 fw-semibold lh-1">Project & Code</span>
                        ...
                        <div class="d-flex align-items-center py-1">
                            <!--begin::Answers-->
                            <a href="apps/devs/question.html#answers" class="btn btn-sm btn-outline btn-outline-dashed btn-outline-default px-4 me-2">{{ $project->file }}</a>
                            <!--end::Answers-->
                            <!--begin::Tags-->
                            <a href="apps/devs/tag.html" class="btn btn-sm btn-light px-4 me-2">{{ $project->created_at }}</a>
                            <!--end::Tags-->
                            <!--begin::Upvote-->
                            <a href="{{ route('project.detail', ['id' => $project->id]) }}" class="btn btn-sm btn-flex btn-light px-3" data-bs-toggle="tooltip" title="Detail Project & Code" data-bs-dismiss="click">Detail  
