...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="portal belajar dan MOOC yang menyajikan tutorial informatika, artikel, berita terkini, serta contoh program lengkap dengan source code untuk memperdalam pemahaman tentang dunia informatika." />
		<meta name="keywords" content="mooc, belajar, online, informatika, technology, berita, code, programming" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="ZonaInformatika" />
		<meta property="og:url" content="https://zonainformatika.com" />
		<meta property="og:site_name" content="ZonaInformatika by IntegerHead" />
		...
		<link href="{{ url('/')}}/ui/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
		<link href="{{ url('/')}}/ui/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
		<link href="{{ url('/')}}/ui/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="{{ url('/')}}/ui/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-enabled sidebar-enabled">
					...
					<div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
						...
						<div class="d-flex justify-content-start mb-10">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<a href="https://zonainformatika.com">ZonaInformatika</a></div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
		...
		<script src="{{ url('/')}}/ui/assets/plugins/global/plugins.bundle.js"></script>
		<script src="{{ url('/')}}/ui/assets/js/scripts.bundle.js"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Vendors Javascript(used for this page only)-->
		<script src="{{ url('/')}}/ui/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		...
		<script src="{{ url('/')}}/ui/assets/plugins/custom/datatables/datatables.bundle.js"></script>
		<!--end::Vendors Javascript-->
		<!--begin::Custom Javascript(used for this page only)-->
		<script src="{{ url('/')}}/ui/assets/js/widgets.bundle.js"></script>
		<script src="{{ url('/')}}/ui/assets/js/custom/widgets.js"></script>
		<script src="{{ url('/')}}/ui/assets/js/custom/apps/chat/chat.js"></script>
		<script src="{{ url('/')}}/ui/assets/js/custom/utilities/modals/upgrade-plan.js"></script>
		<script src="{{ url('/')}}/ui/assets/js/custom/utilities/modals/users-search.js"></script>
